...
export const Route = createFileRoute("/contacts/new")({
  head: () => ({
    meta: [{ title: "New Contact — Yo-Kai Express Sales OS" }],
  }),
  ...
  return (
    <>
      ...
      <PageHeader
        eyebrow="CRM"
        title="New contact"
        description="Pick the account this person belongs to, then fill in their details."
      />
      ...
      <div className="mx-auto max-w-2xl space-y-5">
        ...
        {account && (
          <Panel title={`Contact — ${account.name}`}>
